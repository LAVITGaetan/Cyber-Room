...
<body>
    ...
    <!-- Requête pour assigner les utilisateurs à un poste-->
    ...
    <!-- Fin de la requête pour assigner les utilisateurs à un poste-->


    <!-- Connexion à la base de données et récupération des données pour chaque poste-->
    ...
    <!-- Fin de la connexion à la base de données et de la récupération des données-->
    ...
    <!-- Création des timers pour les postes-->
    ...
    <script>
        ...
        // Modifier le timer à chaque seconde
        var x = setInterval(function() {
            now = now + 1000;
            // Calcul de la distance entre le timer et maintenant
            ...
            document.getElementById("demo").innerHTML = days + "d " + hours + "h " +
                minutes + "m " + seconds + "s ";
            // Actions quand le timer arrive à 0
            if (distance < 0) {
                clearInterval(x);
    ...
    <footer>
        <div>
            <ul class="mail">
                <li>LAVIT Gaetan<br> <a href="g.lavit@outlook.fr" id="copy"><img src="images/email.png" width="20px" height="20px" /></a>
                    <a href="https://www.linkedin.com/in/gaetan-lavit-d-hautefort-6231241b8/" target="blank"><img src="images/linkedin-rond-300x300.png" width="20px" height="20px" /></a>
                    <a href="https://www.facebook.com/gaetan.lavit.5/" target="blank"><img src="images/Facebook-share-icon.png" width="20px" height="20px" /></a>
                </li>
                <li>GIGAN Dimitri
                ...
                <li>AH-KENG Abel <br> <a href="sandro030601@gmail.com" id="copy"><img src="images/email.png" width="20px" height="20px" /></a>
                    <a href="https://www.linkedin.com/in/abel-ah-keng-4490891b8/" target="blank"><img src="images/linkedin-rond-300x300.png" width="20px" height="20px" /></a>
                    <a href="https://www.facebook.com/abel.akn" target="blank"><img src="images/Facebook-share-icon.png" width="20px" height="20px" /></a>

                <li>BEGE Swann <br> <a href="swann.bege@gmail.com" id="copy"><img src="images/email.png" width="20px" height="20px" /></a>
                    <a href="https://www.linkedin.com/in/swann-bege-56702a1bb/" target="blank"><img src="images/linkedin-rond-300x300.png" width="20px" height="20px" /></a>
                    <a href="https://www.facebook.com/wahib.Qlf/" target="blank"><img src="images/Facebook-share-icon.png" width="20px" height="20px" /></a>
            </ul>
        </div>
